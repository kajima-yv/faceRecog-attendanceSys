...
img = face_recognition.load_image_file('Dataset\Vicko.png')
img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
imgTest = face_recognition.load_image_file('Dataset\Vicko Test.png')
...
faceDist = face_recognition.face_distance([encode], encodeTest)
...
cv2.imshow('Vicko', img)
cv2.imshow('Vicko Test', imgTest)
cv2.waitKey(0)